...
<body>
    ...
    <b>${sessionScope.user.name}早上好，欢迎使用图书管理系统</b>(${sessionScope.user.name}.com)
    ...
    <li><span>您可以进行密码修改、账户设置等操作</span><a class="user/pwd.jsp">账户管理</a></li>
    </ul>
    
    <div class="xline"></div>
    
    <div class="uimakerinfo"><b>查看xjr网站使用指南，您可以了解到更多图书等相关信息</b>(<a href="http://www.uimaker.com" target="_blank">www.uimaker.com</a>)</div>
    
    <ul class="umlist">
    <li><a href="#">如何发布图书</a></li>
    <li><a href="#">如何访问网站</a></li>
    <li><a href="#">如何管理图书</a></li>
